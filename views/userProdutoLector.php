          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Ações">
                <a class="btn btn-warning btn-sm" href="editar_userProdutoLector.php?id_produtos=<?php echo $fila['id_produtos'] ?>">
                  <i class="fa fa-edit"></i> Editar
                </a>
                <a class="btn btn-danger btn-sm btn-del" href="eliminar_ProdutoLector.php?id_produtos=<?php echo $fila['id_produtos'] ?>">
