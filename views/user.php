              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="Ações">
                    <a class="btn btn-warning btn-sm" href="editar_user.php?id_pedidos=<?php echo $fila['id_pedidos'] ?>">
                      <i class="fa fa-edit"></i> Editar
                    </a>
                    <a class="btn btn-danger btn-sm btn-del" href="eliminar_user.php?id_pedidos=<?php echo $fila['id_pedidos'] ?>">
